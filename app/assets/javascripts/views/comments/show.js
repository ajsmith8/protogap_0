Protogap0.Views.CommentsShow = Backbone.View.extend({
	...
	events: {
		'click #comment_reply' : 'commentReply',
		'submit #replycomment' : 'submitComment',
		'click #upvote' : 'upvote',
	...
	renderScore: function() {
		var view = new Protogap0.Views.ScoresShow({
			attr: this.attr,
			comment: this.comment
		});
	...
	getChildren: function(comment) {
		...
		var comments = this.attr.comments.where({fact_id: comment.get('fact_id'), ancestry: ancestry});
		var depth;
